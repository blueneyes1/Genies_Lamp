...
public class BasketService {
	...
	public int basketAdd(String basket_member_id, String basket_product_idx, String basket_count, String basket_price) {
		...
		/*
		 * int result = basketDao.basketCheck( basket_member_id, basket_product_idx );
		 * if ( result==0 ) { int result1 = basketDao.basketAdd(basket_member_id,
		 * basket_product_idx, basket_count, basket_price); if (result1 == 1) { result =
		 * 1; // 장바구니 추가 성공 }else { result = 0; // 장바구니 추가 실패 } }else if( result >= 1) {
