...
<div class="container1">
  ...
  <button class="carousel-control-next" type="button" data-target="#carouselExampleCaptions" data-slide="next">
	...
	<div class="reviewboard2">	
  		...
  		<c:forEach var="main_review" items="${main_review}" >
  			<div class="tableboard1" >
             <table class="table1" >
             	<tr>
              		<td><img src="${main_review.review_img }" id="review_img" ></td>
              	</tr>
              
              	<tr>
              		<td>${main_review.review_title }</td>
             	</tr>
              
             	<tr>
             		<td>${main_review.review_member_id }</td>
             	</tr>
             	
             	<tr>
             		<td>
	              		<c:set var="dateVar" value="${main_review.review_date }" />
