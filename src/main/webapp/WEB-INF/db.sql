...
values (genies_product_seq.nextval, '스탠드', '큐브 미드센추리 스텐드', 'Genie origins', '블랙', '28900', '17', '/upload/2022222115456166.JPG', '전구가 자연스럽게 노출되어 전구 선택에 따른 비비드, 심플, 미니멀, 미드센추리 모던 까지 트렌드의 모든 키워드를 담은 스탠드 조명으로 감각적인 연출이 가능한 인테리어 스탠드 입니다.',  sysdate);
...
insert into genies_product(product_idx, product_type,  product_name, product_brand, product_color, product_price, product_count, product_img1, product_content, product_date)
values (genies_product_seq.nextval, '1', 'LED 태양광 반딧불 정원등', 'Genie origins', '옐로우', '6300', '14', '/upload/2022222093558.JPG', '태양광 전지 패널이 붙어 있어 태양광을 이용해 충전되며 어두운곳에서 센서가 작동하여 마치 병속에 담아둔 반딧불 처럼 반짝이는 분위기를 연출할 수 있습니다. 주거공간, 상업공간 등의 정원등, 무드등으로 추천드립니다.',  sysdate);
