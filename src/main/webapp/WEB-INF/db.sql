...
create table genies_member(
    member_idx       number(50) primary key,
...
create table genies_notice(
    notice_idx      number(50) primary key,
...
create table genies_basket(
    basket_idx      number(50) primary key,
...
create table genies_one2one_reply(
    one2one_reply_idx      number(50) primary key,
...
create table genies_one2one(
    one2one_idx      number(50) primary key,
...
create table genies_order(
	order_idx		number(50) primary key,
	order_pay_idx		number(50),
	order_product_idx		number(50),
...
create table genies_product(
    product_idx      number(50) primary key,
...
create table genies_product_review(
    review_idx      number(50) primary key,
    review_order_idx		number(50),
    review_product_idx    number(50),
